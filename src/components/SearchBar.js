                ...
                <td>
                    ...
                    <div className={"card blue-grey " + extraClasses}>
                        ...
                        <div className="card-action">
                            ...
                            <a target="_blank" rel="noopener noreferrer"
                               href={'https://drive.google.com/drive/folders/1LW8qyRjnoglIISmEfxCPzkAhPMsVRAIR?usp=sharing'}
                               className="btn waves-effect waves-light blue-grey darken-3">Materials</a>
